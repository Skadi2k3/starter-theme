 ...
 * Fields
 */
if ( !class_exists('PlayerProfiles') ):
...
class PlayerProfiles
{
	...
	public function dependencies_check() {
	   return ( is_plugin_active('advanced-custom-fields/acf.php') || is_plugin_active('advanced-custom-fields-pro/acf.php') ) ? true : false;
	}
	...
	public function admin_notice() {
		...
		<div class="error">
			<p>
				<strong>Team Profiles</strong> needs the <a href="http://www.advancedcustomfields.com/" target="_blank">Advanced Custom Fields</a> plugin to work. Please <a href="<?php echo $install_link ?>">install it now</a>
			</p>
		</div>
		<?php
	}
	...
	public function register_post_type() {
	   ...
	   // Labels
		$labels = array(
			'name' => _x("Player", "post type general name"),
	...
	static function display() {
		...
		$transient_label = __CLASS__ . "_" . __FUNCTION__; // Transient label will be 'PlayerProfiles_display'
